...
exports.changePassword = (email, password, newPassword) => 
	...
	new Promise((resolve, reject) => {
		...
		.catch(err => reject({ status: 500, message: 'Internal Server Error !' },console.log("eeror",err)));
	...
	new Promise((resolve, reject) => {
		...
		.then(user => {
			...
			const mailOptions = {
    			...
    			If you are viewing this mail from a Android Device click this <a href="http://traficty/${random}">link</a>. 
